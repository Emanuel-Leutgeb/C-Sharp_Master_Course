...
{
    public class Mehr_als_2_Datenquellen_miteinander_verknüpfen
    {
        public Mehr_als_2_Datenquellen_miteinander_verknüpfen()
        {
            //Customers
            ...
            var orderQuery = from order in orderList
                             ...
                             join adress in adressList
                             on order.AdressID equals adress.AdressID
                             select new
                             {
            ...
            {
                Console.WriteLine(order.CustomerName + " bought " + order.Product + " - " + order.AdressLine);
            }
