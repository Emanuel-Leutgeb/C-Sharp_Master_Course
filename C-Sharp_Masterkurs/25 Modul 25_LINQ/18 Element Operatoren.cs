...
{
    public class Element_Operatoren
    {
        public Element_Operatoren()
        {
            //Customers
            ...
            Console.WriteLine(customerQuery.ElementAt(2));
            Console.WriteLine(customerQuery.ElementAtOrDefault(4));

            Console.WriteLine(customerQuery.First());
            Console.WriteLine(customerQuery.First(name => name.Contains("Miriam")));
            Console.WriteLine(customerQuery.FirstOrDefault(name => name.Contains("KEIN NAME")));

            Console.WriteLine(customerQuery.Last());
            Console.WriteLine(customerQuery.LastOrDefault(name => name.Contains("Sandra")));
            Console.WriteLine(customerQuery.LastOrDefault(name => name.Contains("PENIS")));

            Console.WriteLine(customerQuery.Single(name => name.Contains("Emanuel")));
            Console.WriteLine(customerQuery.SingleOrDefault(name => name.Contains("Huemer")));
        }
    }
