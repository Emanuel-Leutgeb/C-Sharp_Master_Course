...
{
    public class Komplexere_Abfragen_mit_Aufrufketten
    {
        public Komplexere_Abfragen_mit_Aufrufketten()
        {
            ...
            var query1 = studentList.Where((student) => student.Age < 30).OrderByDescending((student) => student.LastName).ThenBy((student) => student.FirstName);
