...
namespace C_Sharp_Masterkurs.Modul25_LINQ
{
    public class Join_mit_der_Methoden_Syntax
    {
        public Join_mit_der_Methoden_Syntax()
        {
            ...
            var orderQuery = orderList.Join(customerList, order => order.CustomerID, customer => customer.CustomerID, (order, customer) => new { Product = order.ProductName, CustomerName = customer.Name });
